...
The docs for this module can be found on CPAN right
L<http://search.cpan.org/perldoc?Pod::Cats|here>, whence you can also download
the distribution if you like.
